...
\begin{center}
    ...
    Software Engineer \\
    \faEnvelopeO~\href{mailto:jishnu.jjp97@gmail.com}{\textcolor{gray}{jishnu.jjp97@gmail.com}} \quad
    \faLinkedinSquare~\href{https://www.linkedin.com/in/jishnu-j-p}{\textcolor{gray}{jishnu-j-p}} \quad
    \faTwitter~\href{https://x.com/Jishnu_J_P}{\textcolor{gray}{Jishnu\_J\_P}} \quad
    \faGithub~\href{https://github.com/jishnujp}{\textcolor{gray}{jishnujp}} \quad
...
\textit{Founding Engineer} \hfill \textit{Remote} \begin{itemize}[leftmargin=*]
    \item Built Blinxed from concept to production as a founding team member — owned the full technical stack including architecture design, frontend and backend development, and deployment.
    \item Designed the AI agents powering core product features, including LLM driven workflows and automated pipelines that handle key functionality from ingestion to output.
    \item Set up cloud infrastructure on GCP with CI/CD pipelines, shipped the product to production, and hired and led an engineering team of three through onboarding and code reviews.
\end{itemize}
...
\faGithub~\href{https://github.com/21f1006194/quizmaster}{\textcolor{gray}{repo}} \, \textbar{} \,
\faPlayCircle~\href{https://youtu.be/9D6rJ8Ubrwg}{\textcolor{gray}{demo}}
